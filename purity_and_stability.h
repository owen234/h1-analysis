...
// Tue Oct 26 08:53:16 2021 by ROOT version 6.24/01
// from TChain dnnout/
//////////////////////////////////////////////////////////

#ifndef purity_and_stability_h
#define purity_and_stability_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   purity_and_stability(TTree *tree=0);
   virtual ~purity_and_stability();
...
#ifdef purity_and_stability_cxx
purity_and_stability::purity_and_stability(TTree *tree) : fChain(0) 
{
...
purity_and_stability::~purity_and_stability()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t purity_and_stability::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t purity_and_stability::LoadTree(Long64_t entry)
{
...
void purity_and_stability::Init(TTree *tree)
{
...
Bool_t purity_and_stability::Notify()
{
...
void purity_and_stability::Show(Long64_t entry)
{
...
Int_t purity_and_stability::Cut(Long64_t entry)
{
...
#endif // #ifdef purity_and_stability_cxx
