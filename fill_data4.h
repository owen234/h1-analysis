...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fill_data4(TTree *tree=0);
   virtual ~fill_data4();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( const char* rur_file_name = "unfold-hists-h1-binning.root" );
...
#ifdef fill_data4_cxx
fill_data4::fill_data4(TTree *tree) : fChain(0) 
{
...
fill_data4::~fill_data4()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_data4::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_data4::LoadTree(Long64_t entry)
{
...
void fill_data4::Init(TTree *tree)
{
...
void fill_data4::Show(Long64_t entry)
{
...
Int_t fill_data4::Cut(Long64_t entry)
{
