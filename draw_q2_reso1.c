...
char gen_or_obs[100] ;
   ...
   void draw_q2_reso( const char* gen_or_obs_arg = "gen", const char* infile = "q2_reso_hists.root", const char* infile2 = "" ) {
  ...
  //-------------------------------------------------------------------------------------------------
   ...
   void dynamic_draw_x_reso() {
      ...
      char hname[1000] ;
      sprintf( hname, "h_q2_meas_over_q2_gen__%s_binning_gbi%03d", gen_or_obs, gbi ) ;
      ...
      if ( h_xreso != 0x0 ) {
         ...
         sprintf( hname, "h_q2_meas_over_q2_gen__%s_binning_gbi%03d_2", gen_or_obs, gbi ) ;
      ...
      sprintf( hname, "h_q2_meas_minus_q2_gen_over_bw__%s_binning_gbi%03d", gen_or_obs, gbi ) ;
      ...
      if ( h_xdiff != 0x0 ) {
         ...
         sprintf( hname, "h_x_meas_minus_x_gen_over_bw__%s_binning_gbi%03d_2", gen_or_obs, gbi ) ;
