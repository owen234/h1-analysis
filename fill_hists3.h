...
#ifndef fill_hists3_h
#define fill_hists3_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fill_hists3( const char* input_file_pattern = "dnn-output-h1-v2-Rapgap.root" );
   virtual ~fill_hists3();
...
#ifdef fill_hists3_cxx
fill_hists3::fill_hists3( const char* input_file_pattern ) : fChain(0) 
{
...
fill_hists3::~fill_hists3()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_hists3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_hists3::LoadTree(Long64_t entry)
{
...
void fill_hists3::Init(TTree *tree)
{
...
void fill_hists3::Show(Long64_t entry)
{
...
Int_t fill_hists3::Cut(Long64_t entry)
{
