...
// Fri Nov 19 16:03:12 2021 by ROOT version 6.24/01
// from TChain dnnout/
//////////////////////////////////////////////////////////

#ifndef fill_fake_data3_h
#define fill_fake_data3_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fill_fake_data3(TTree *tree=0);
   virtual ~fill_fake_data3();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( int seed = 1, int number_of_events = 185071, const char* rur_file_name = "rapgap-for-q2-vs-y-gen012_obs024-0.05-obs-good.root" );
...
#ifdef fill_fake_data3_cxx
fill_fake_data3::fill_fake_data3(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("dnn-output-h1-v2-Rapgap.root/dnnout");
      tree = chain;
#endif // SINGLE_TREE
...
fill_fake_data3::~fill_fake_data3()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_fake_data3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_fake_data3::LoadTree(Long64_t entry)
{
...
void fill_fake_data3::Init(TTree *tree)
{
...
void fill_fake_data3::Show(Long64_t entry)
{
...
Int_t fill_fake_data3::Cut(Long64_t entry)
{
...
#endif // #ifdef fill_fake_data3_cxx
