#define fill_fake_data_cxx
#include "fill_fake_data.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void fill_fake_data::Loop( int seed, int number_of_events, const char* rur_file_name )
{
   if (fChain == 0) return;
  ...
  //     to ensure consistency.
   ...
   char fname[1000] ;
   sprintf( fname, "fake-data-hists-seed-%d.root", seed ) ;
   saveHist( fname, "*" ) ;
