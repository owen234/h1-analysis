...
#include "TLegend.h"
  ...
  //==========================================================================
     ...
     //--use this one for the reco distribution.

   TH2F* make_q2_vs_x_ultra_fine_reco_h1_binning( const char* hname ) {

      int nbins_q2 = 38 ;
      int nbins_x = 61 ;
      double q2_bin_low_edge[] = { 177.8, 199.5, 223.9, 251.2, 281.8, 316.2, 354.8, 398.1, 446.7, 501.2, 562.3, 631.0, 707.9, 794.3, 891.3, 1000.0, 1122.0, 1258.9, 1412.5, 1584.9, 1778.3, 1995.3, 2238.7, 2511.9, 2818.4, 3162.3, 3548.1, 4570.9, 5888.4, 7585.8, 9772.4, 12589.3, 16218.1, 20893.0, 26915.3, 34673.7, 44668.4, 57544.0, 74131.0 } ;
      double x_bin_low_edge[] = { 0.00148, 0.00166, 0.00186, 0.00209, 0.00234, 0.00263, 0.00295, 0.00331, 0.00372, 0.00417, 0.00468, 0.00525, 0.00589, 0.00661, 0.00741, 0.00832, 0.00933, 0.01047, 0.01175, 0.01318, 0.01479, 0.01660, 0.01862, 0.02089, 0.02344, 0.02630, 0.02951, 0.03311, 0.03715, 0.04169, 0.04677, 0.05248, 0.05888, 0.06607, 0.07413, 0.08318, 0.09333, 0.10233, 0.11220, 0.12303, 0.13490, 0.14791, 0.16218, 0.17783, 0.19498, 0.21380, 0.23442, 0.25704, 0.28184, 0.30903, 0.33884, 0.37154, 0.40738, 0.44668, 0.48978, 0.53703, 0.58884, 0.64565, 0.70795, 0.77625, 0.85114, 1.00000 } ;
  ...
  //==========================================================================
     ...
     //-- use this one for the unfolded distribution of the one above (make_q2_vs_x_ultra_fine_h1_binning)
     //     This has the old H1 binning for Q2 and a finer binning in x.

   TH2F* make_q2_vs_x_ultra_fine_unfolded_h1_binning( const char* hname ) {
