...
#include "histio.c"
   ...
   void fill_norad_nom_hists(
    ...
    //-----
      ...
      ch_norad.Draw( "2.*beam_e_e*(gen_e_e+gen_e_pz) >> h_q2_norad", "wgt*(2.*beam_e_e*(gen_e_e+gen_e_pz)>200)" ) ;
      ...
      ch_nom.Draw( "2.*beam_e_e*(gen_e_e+gen_e_pz) >> h_q2_nom", "wgt*(2.*beam_e_e*(gen_e_e+gen_e_pz)>200)" ) ;
    ...
    //-----
      ...
      ch_norad.Draw( "2.*beam_e_e*(gen_e_e+gen_e_pz) >> h_q2_norad_low", "wgt*(2.*beam_e_e*(gen_e_e+gen_e_pz)>200)" ) ;
      ...
      ch_nom.Draw( "2.*beam_e_e*(gen_e_e+gen_e_pz) >> h_q2_nom_low", "wgt*(2.*beam_e_e*(gen_e_e+gen_e_pz)>200)" ) ;
    ...
    //-----
      ...
      ch_norad.Draw( "log10(2.*beam_e_e*(gen_e_e+gen_e_pz)) >> h_log10q2_norad", "wgt*(2.*beam_e_e*(gen_e_e+gen_e_pz)>200)" ) ;
      ...
      ch_nom.Draw( "log10(2.*beam_e_e*(gen_e_e+gen_e_pz)) >> h_log10q2_nom", "wgt*(2.*beam_e_e*(gen_e_e+gen_e_pz)>200)" ) ;
...
//    can1 -> Update() ; can1 -> Draw() ; gSystem -> ProcessEvents() ;
      ...
      saveHist( "simple-norad-nom-hists.root", "h*" ) ;
