#define fill_hists4b_cxx
#include "fill_hists4b.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void fill_hists4b::Loop( bool verbose, int last_event, int first_event, const char* out_file )
{
   ...
   TH2F* h_q2_vs_x_obs_dnn_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_dnn_sel" ) ;
   TH2F* h_q2_vs_x_obs_e_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_e_sel" ) ;
   TH2F* h_q2_vs_x_obs_esigma_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_esigma_sel" ) ;
   TH2F* h_q2_vs_x_obs_isigma_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_isigma_sel" ) ;
   TH2F* h_q2_vs_x_obs_da_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_da_sel" ) ;

   TH2F* h_q2_vs_x_obs_gen_same_dnn_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_gen_same_dnn_sel" ) ;
   TH2F* h_q2_vs_x_obs_gen_same_e_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_gen_same_e_sel" ) ;
   TH2F* h_q2_vs_x_obs_gen_same_esigma_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_gen_same_esigma_sel" ) ;
   TH2F* h_q2_vs_x_obs_gen_same_isigma_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_gen_same_isigma_sel" ) ;
   TH2F* h_q2_vs_x_obs_gen_same_da_sel = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_q2_vs_x_obs_gen_same_da_sel" ) ;



   TH2F* h_q2_vs_x_meas_binning_obs_dnn_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_dnn_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_e_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_e_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_esigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_esigma_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_isigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_isigma_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_da_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_da_sel" ) ;

   TH2F* h_q2_vs_x_meas_binning_obs_gen_same_dnn_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_gen_same_dnn_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_gen_same_e_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_gen_same_e_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_gen_same_esigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_gen_same_esigma_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_gen_same_isigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_gen_same_isigma_sel" ) ;
   TH2F* h_q2_vs_x_meas_binning_obs_gen_same_da_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_meas_binning_obs_gen_same_da_sel" ) ;
   ...
   TH2F* h_q2_vs_x_gen_no_cuts = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_no_cuts" ) ;

   TH2F* h_q2_vs_x_gen_dnn_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_dnn_sel" ) ;
   TH2F* h_q2_vs_x_gen_e_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_e_sel" ) ;
   TH2F* h_q2_vs_x_gen_esigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_esigma_sel" ) ;
   TH2F* h_q2_vs_x_gen_isigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_isigma_sel" ) ;
   TH2F* h_q2_vs_x_gen_da_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_da_sel" ) ;


   TH2F* h_q2_vs_x_gen_rec_same_dnn_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_rec_same_dnn_sel" ) ;
   TH2F* h_q2_vs_x_gen_rec_same_e_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_rec_same_e_sel" ) ;
   TH2F* h_q2_vs_x_gen_rec_same_esigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_rec_same_esigma_sel" ) ;
   TH2F* h_q2_vs_x_gen_rec_same_isigma_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_rec_same_isigma_sel" ) ;
   TH2F* h_q2_vs_x_gen_rec_same_da_sel = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_q2_vs_x_gen_rec_same_da_sel" ) ;
   ...
   TH2F* h_dummy_q2_vs_x_gen = make_q2_vs_x_ultra_fine_unfolded_h1_binning( "h_dummy_q2_vs_x_gen" ) ;
   TH2F* h_dummy_q2_vs_x_obs = make_q2_vs_x_ultra_fine_reco_h1_binning( "h_dummy_q2_vs_x_obs" ) ;
   ...
   if ( strlen( out_file ) > 0 ) {
      ...
      sprintf( save_file, "unfold-hists-h1-binning-v4b.root" ) ;
   }
