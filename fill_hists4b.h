...
#ifndef fill_hists4b_h
#define fill_hists4b_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //fill_hists4b( const char* input_file_pattern = "dnn-output-h1-v2-Rapgap.root" );
   //fill_hists4b( const char* input_file_pattern = "/Volumes/Ext_2020_08/dis-reco-work/h1-2021-10-14-v5f/dnn-output-h1-v2-Rapgap-all-events.root" );
   fill_hists4b( const char* input_file_pattern = "dnn-output-h1-v2-Rapgap-all-events.root" );
   virtual ~fill_hists4b();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( bool verbose=false, int last_event=-1, int first_event=0, const char* out_file = "" );
...
#ifdef fill_hists4b_cxx
fill_hists4b::fill_hists4b( const char* input_file_pattern ) : fChain(0) 
{
...
fill_hists4b::~fill_hists4b()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_hists4b::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_hists4b::LoadTree(Long64_t entry)
{
...
void fill_hists4b::Init(TTree *tree)
{
...
void fill_hists4b::Show(Long64_t entry)
{
...
Int_t fill_hists4b::Cut(Long64_t entry)
{
