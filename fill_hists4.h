...
#ifndef fill_hists4_h
#define fill_hists4_h
...
#ifdef fill_hists4_cxx
fill_hists4::fill_hists4( const char* input_file_pattern ) : fChain(0) 
{
...
fill_hists4::~fill_hists4()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_hists4::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_hists4::LoadTree(Long64_t entry)
{
...
void fill_hists4::Init(TTree *tree)
{
...
void fill_hists4::Show(Long64_t entry)
{
...
Int_t fill_hists4::Cut(Long64_t entry)
{
