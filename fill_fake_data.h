...
#ifndef fill_fake_data_h
#define fill_fake_data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fill_fake_data(TTree *tree=0);
   virtual ~fill_fake_data();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( int seed = 1, int number_of_events = 185071, const char* rur_file_name = "rapgap-for-q2-vs-y-gen012_obs024-0.05-gen-good.root" );
...
#ifdef fill_fake_data_cxx
fill_fake_data::fill_fake_data(TTree *tree) : fChain(0) 
{
...
Int_t fill_fake_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_fake_data::LoadTree(Long64_t entry)
{
...
void fill_fake_data::Init(TTree *tree)
{
...
void fill_fake_data::Show(Long64_t entry)
{
...
Int_t fill_fake_data::Cut(Long64_t entry)
{
...
#endif // #ifdef fill_fake_data_cxx
