...
#ifndef fill_hists5_h
#define fill_hists5_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //fill_hists5( const char* input_file_pattern = "dnn-output-h1-v2-Rapgap.root" );
   fill_hists5( const char* input_file_pattern = "/Volumes/Ext_2020_08/dis-reco-work/h1-2021-10-14-v5f/dnn-output-h1-v2-Rapgap-all-events.root" );
   virtual ~fill_hists5();
...
#ifdef fill_hists5_cxx
fill_hists5::fill_hists5( const char* input_file_pattern ) : fChain(0) 
{
...
fill_hists5::~fill_hists5()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_hists5::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_hists5::LoadTree(Long64_t entry)
{
...
void fill_hists5::Init(TTree *tree)
{
...
void fill_hists5::Show(Long64_t entry)
{
...
Int_t fill_hists5::Cut(Long64_t entry)
{
